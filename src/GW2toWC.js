            ...
            <div className="imgbox">
                ...
                <Router>
                    <div className="buttonFloat">
                        <Link to="/george2"><button className="btn btn-primary" style={{'font-family':'BodyFont'}}>Previous Stop</button></Link>
                        <Link to="/westcampus"><button className="btn btn-primary" style={{'font-family':'BodyFont'}}>Continue</button></Link>
                    </div>
                </Router>
            </div>
        )
