            ...
            <div className="imgbox">
                ...
                <Router>
                    <div className="buttonFloat">
                        <Link to="/suzzalo"><button className="btn btn-primary" style={{'font-family':'BodyFont'}}>Previous Stop</button></Link>
                        <Link to="/marygates"><button className="btn btn-primary" style={{'font-family':'BodyFont'}}>Continue</button></Link>
                    </div>
                </Router>
            </div>
        )
